...
class BrandProductController extends Controller
{
    ...
    public function all_brand_product()
    {
        ...
        $manager_brand_product = view('admin.Brand.allBrandProduct')->with('all_brand_product',$all_brand_product);
        return view('admin_layout')->with('admin.Brand.allBrandProduct',$manager_brand_product);
    }
    ...
    public function edit_brand_product($brand_product_id)
    {
        ...
        $manager_brand_product = view('admin.Brand.editbrandProduct')->with('edit_brand_product',$edit_brand_product);

        return view('admin_layout')->with('admin.Brand.editbrandProduct',$manager_brand_product);
    }
    ...
    public function show_brand_home($brand_id)
    {
        ...
        $brand_name = DB::table('tbl_brand_products')->where('tbl_brand_products.brand_id',$brand_id)->limit(1)->get(); //lấy ra tên 1 thương hiệu

        return view('pages.brand.showBrand')->with('category',$cate_product)->with('brand',$brand_product)
