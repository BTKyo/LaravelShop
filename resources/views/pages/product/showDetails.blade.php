						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<span>
									...
									<input name="producid_hidden" type="hidden" value="{{$value->product_id}}" />
								...
								<p><b>Màu sắc:</b> {{$value->color_name}}</p>
								<p><b>Size:</b> {{$value->size_name}}</p>
									...
									<div class="col-sm-4">
										...
										<div class="single-products">
											<div class="productinfo text-center">
												<img src="{{URL::to('public/upload/products/'.$related->product_image)}}" alt="" />
